...
\begin{figure*}[!t]
  ...
  \caption{AUC across all three classifiers for scenarios A, B and C. The green dashed line marks AUC~$= 0.8$ and the red dashed line marks AUC~$= 0.5$. Every combination clears 0.8. Gradient Boosting under Scenario~A achieves the highest AUC at 0.878.}
  \label{figS:auc}
\end{figure*}
